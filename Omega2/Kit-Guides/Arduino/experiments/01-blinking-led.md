...
// TODO: insert a gif of what this experiment will accomplish, need to get people excited!
...
* Jumper wires
* Resistors
  * 1x 200Ω // TODO: fix this indent!
* 1x LED color of your choice!

#### Hooking up the Components

We're going to be building the following circuit:
...
// TODO: need explicit commenting in the code
```arduino
int ledPin = 4;             // LED on pin 4
int blinkTime = 1000;       // duration to keep the LED on/off in ms

void setup() {			// codes to be run once when the program starts
    pinMode(ledPin, OUTPUT);
}

void loop() {			// codes to be run continuously
